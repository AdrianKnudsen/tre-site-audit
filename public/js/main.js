...
const FUN_FACTS = [
  ...
  "E-post er eldre enn internett — Ray Tomlinson sendte første e-post i 1971, internett kom på 80-tallet.",
  "Den første nettsiden finnes fortsatt — info.cern.ch er oppe den dag i dag.",
  "HTML ble aldri ment for design — Tim Berners-Lee designet det kun for å dele vitenskapelige dokumenter.",
  "GIF er eldre enn World Wide Web — oppfunnet i 1987, WWW i 1991.",
  "Python er ikke oppkalt etter slangen — Guido van Rossum oppkalte det etter Monty Python.",
  '"Viewport" meta-taggen er ikke en HTML-standard — Apple fant den opp for Safari på iPhone, og alle kopierte den.',
  "Wayback Machine lagrer over 800 milliarder nettsider — og bruker petabytes av lagring i en gammel kirke i San Francisco.",
  "Chrome har over 35 millioner linjer med kode — til sammenligning hadde Apollo 11s navigasjonscomputer 145 000 linjer.",
  'Passordet "123456" har blitt lekket over 24 millioner ganger — det er fortsatt verdens mest brukte passord hvert eneste år.',
  '"Wi-Fi" betyr ingenting — det er ikke en forkortelse for noe. Navnet ble funnet opp av et merkevarebyråfor å høres bedre ut enn det tekniske navnet "IEEE 802.11b Direct Sequence."',
  'Det finnes ingen "slett fra internett"-knapp — selv om du sletter noe, kan det ligge i cacher, arkiver og andres skjermbilder for alltid.',
];
