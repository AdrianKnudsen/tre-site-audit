...

{
  ...
  "priorityFixes": [
    { "title_no": "...", "title_en": "...", "description_no": "Beskriv problemet fra brukerens perspektiv + konkret forretningskonsekvens", "description_en": "Describe the problem from the user's perspective + concrete business impact", "severity": "high|medium|low", "domain": "UX|UI|Accessibility|Best Practices" }
  ],
  "customerSummary": {
    "no": "4-5 avsnitt på norsk. Skriv fra «vi»-perspektiv, som et byrå som snakker naturlig til kunden (f.eks. «Vi ser at...», «Analysen vår viser...», «Vi anbefaler...»). ALDRI bruk: tallscorer, prosenter, fargekoder, hex-verdier, tekniske forkortelser (LCP, CLS, TTFB osv.), eller kodesnutter. ALDRI nevn juridiske konsekvenser, lovkrav, WCAG-krav, bøter, søksmål eller liknende — hold fokus utelukkende på brukeropplevelse og forretningsverdi.\n\nSTRUKTUR (følg denne rekkefølgen):\n1. ÅPNING (1 avsnitt): Start positivt — trekk fram det siden gjør bra. Anerkjenn styrker konkret (f.eks. god navigasjon, rask lasting, tydelig merkevare). Dette bygger tillit.\n2. FORBEDRINGSPOTENSIAL (2-3 avsnitt): Beskriv de viktigste forbedringsområdene. Forklar hva brukerne faktisk opplever (f.eks. «besøkende på mobil må scrolle lenge for å finne kontaktinfo»). Knytt hvert punkt til konkret forretningsverdi — tapte kunder, lavere konvertering, svekket tillit. Bruk språk som gjør det tydelig at dette er muligheter, ikke kritikk.\n3. AVSLUTNING (1 avsnitt): Oppsummer det totale potensialet. Gi kunden en følelse av at forbedringene er oppnåelige og vil gi merkbar effekt. Avslutt med en tydelig anbefaling om neste steg.\n\nTONE: Profesjonell, varm og rådgivende. Vi er på kundens side. Skriv slik at kunden tenker «dette må vi ta tak i» — ikke «dette var ille». Skill avsnittene med \\n\\n.",
    "en": "4-5 paragraphs in English. Write from a 'we' perspective, as an agency speaking naturally to the client (e.g. 'We see that...', 'Our analysis shows...', 'We recommend...'). NEVER use: numeric scores, percentages, color codes, hex values, technical abbreviations (LCP, CLS, TTFB etc.), or code snippets. NEVER mention legal consequences, legal requirements, WCAG compliance obligations, fines, lawsuits or similar — focus exclusively on user experience and business value.\n\nSTRUCTURE (follow this order):\n1. OPENING (1 paragraph): Start positive — highlight what the site does well. Acknowledge strengths specifically (e.g. good navigation, fast loading, clear branding). This builds trust.\n2. IMPROVEMENT POTENTIAL (2-3 paragraphs): Describe the most important areas for improvement. Explain what users actually experience (e.g. 'mobile visitors have to scroll far to find contact info'). Connect each point to concrete business value — lost customers, lower conversion, weakened trust. Use language that frames these as opportunities, not criticism.\n3. CLOSING (1 paragraph): Summarize the overall potential. Give the client a sense that improvements are achievable and will have noticeable impact. End with a clear recommendation for next steps.\n\nTONE: Professional, warm, and advisory. We are on the client's side. Write so the client thinks 'we need to address this' — not 'this was bad'. Separate paragraphs with \\n\\n."
  },
  "executiveSummary": {
...
- Priority fixes should list the 5-10 most impactful issues, sorted by severity. Each fix MUST explain the business impact (lost revenue, lower trust, fewer conversions, etc.). NEVER mention legal consequences, fines, or compliance obligations.
- Customer summary and executive summary MUST be written from a natural «vi»-perspective, as an agency talking to their client (e.g. «Vi ser at...», «Analysen vår viser...»). NEVER mention legal/juridiske konsekvenser. Must be plain language — no scores, no hex codes, no technical jargon.
