/**
 * Asset Fetcher — fetches ALL external CSS and JS files referenced in HTML.
 * No file count or size limits. Full analysis of the entire site.
 *
 * Timeouts per file: 15s (generous for large bundles).
 * Total timeout: 60s for all assets combined.
 */
